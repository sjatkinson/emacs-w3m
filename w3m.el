...
TO-COMMAND in the keymap generated by `w3m-make-minor-mode-keymap'.
When TO-COMMAND is nil, FROM-COMMAND is defined to the generated
keymap for same keys in `w3m-mode-map'.")
